...
for generated_file in AGENTS.md docs/agent-harness.md; do
  grep -Fq -- '<!-- Generated by ai-first 1.5.0-dev.' "$generated_file" ||
...
expected = {
    "version": "1.5.0-dev",
    "source_kind": "commit",
    "source_revision": "dc804321789c56671837a63e23ace2e71d9a2c1e",
    "source_commit": "dc804321789c56671837a63e23ace2e71d9a2c1e",
}
