...
- 공통 하네스: `docs/agent-harness.md`; 상세 정책/루프: `docs/agent-operating-contract.md`, `docs/agent-autonomy-playbook.md`.
...
- 제품 경계, native 검증과 게시 절차는 `docs/agent-operating-contract.md`를 따른다.
